<!-- Footer -->
    <footer class="bg-dark-lighter border-t border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                <!-- Company Info -->
                <div>
                    <a href="<?php echo url(); ?>" class="flex items-center gap-3 mb-4">
                    ...
                    <p class="text-gray-400 mb-4">
                        شركة تسويق إلكتروني مدعومة بالذكاء الاصطناعي. نحوّل أفكارك إلى نجاحات رقمية.
                    </p>
                    <!-- Social Links -->
                    <div class="flex gap-4">
                        <a href="<?php echo SOCIAL_FACEBOOK; ?>" target="_blank" rel="noopener noreferrer"
                           class="w-10 h-10 rounded-lg bg-white/5 hover:bg-primary/20 flex items-center justify-center text-gray-400 hover:text-primary transition-colors duration-300">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="<?php echo url(); ?>" class="text-gray-400 hover:text-primary transition-colors duration-300">الرئيسية</a></li>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="<?php echo url('services.php#design'); ?>" class="text-gray-400 hover:text-primary transition-colors duration-300">التصميم الجرافيكي</a></li>
                        <li><a href="<?php echo url('services.php#social'); ?>" class="text-gray-400 hover:text-primary transition-colors duration-300">السوشيال ميديا</a></li>
                        <li><a href="<?php echo url('services.php#marketing'); ?>" class="text-gray-400 hover:text-primary transition-colors duration-300">التسويق الرقمي</a></li>
                        <li><a href="<?php echo url('services.php#video'); ?>" class="text-gray-400 hover:text-primary transition-colors duration-300">إنتاج الفيديو</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-gray-400">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            <a href="mailto:<?php echo CONTACT_EMAIL; ?>" class="hover:text-primary transition-colors">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            <a href="tel:<?php echo str_replace(' ', '', CONTACT_PHONE); ?>" class="hover:text-primary transition-colors">
